...
RUN_STRINGS = (
    ...
    "എന്നെ ചീത്ത വിളിക്കൂ... വേണമെങ്കിൽ നല്ല ഇടി ഇടിക്കൂ... പക്ഷേ ഉപദേശിക്കരുത്!",
    "ഓ ബ്ലഡി ഗ്രാമവാസീസ്!",
    ...
    "മോന്തയ്ക്കിട്ട് ഒന്നു കൊടുത്തിട്ട് ആ കണ്ണാടി എടുത്ത് കാണിച്ചുകൊടുക്ക്, അപ്പോൾ കാണും ISI മാർക്ക്!",
    "ഡേവീസേട്ടാ, കിങ്ഫിഷറിണ്ടാ? ചിൽഡ്...!",
    "പാതിരാത്രിക്ക് നിന്റെ അച്ഛൻ ഉണ്ടാക്കി വെച്ചിരിക്കുന്നോ പൊറോട്ടയും ചിക്കനും?",
    "ഇതൊക്കെ ഞങ്ങളുടെ പണിസാധനങ്ങളാ രാജാവേ...",
    "കളിക്കല്ലേ, കളിച്ചാൽ കളി പഠിപ്പിക്കും!",
...
SLAP_TEMPLATES = (
    ...
    "{user1} തടിക്കഷണം കൊണ്ട് {user2} ന്റെ മുഖത്തു അടിച്ചു!",
    "{user1} {user2} നെ കാലിൽ പിടിച്ചു കറക്കി എറിഞ്ഞു!",
    "{user1} വലിയ ഒരു കല്ല് എടുത്ത് {user2} ന്റെ തലയിലേക്ക് ഇട്ടു!",
    "{user1} ഒരു വലിയ പാത്രം എടുത്ത് {user2} ന്റെ മുഖത്ത് ആഞ്ഞടിച്ചു!",
    "{user1} {user2} ന്റെ തലക്ക് ഇരുമ്പ് പൈപ്പ് വെച്ചടിച്ചു!",
    "{user1} ഭിത്തിയിൽ തൂക്കിയിട്ടിരുന്ന ക്ലോക്ക് എടുത്ത് {user2} ന്റെ പ്രധാന ഭാഗത്ത് അടിച്ചു!",
    "{user1} {user2} നെ കുനിച്ചു നിർത്തി വലിയൊരു തടിക്കഷണം മുതുകത്തിട്ടു!",
